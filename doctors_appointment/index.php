...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
            <a class="navbar-brand js-scroll-trigger" href="./"> Doctor’s Appointment System</a>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mr-auto text-center">
                        ...
                        <a class="d-block" href="mailto:<?php echo $_SESSION['setting_email'] ?>">aymen.bouguerra.95@gmail.com</a>
                    </div>
                </div>
            </div>
            <br>
